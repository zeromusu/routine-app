...
func (_m *RoutineUseCase) GetRoutine(ID int) (*domain.Routine, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRoutine")
	}
...
// UpdateRoutine provides a mock function with given fields: id, title, interval
func (_m *RoutineUseCase) UpdateRoutine(id int, title string, interval string) (*domain.Routine, error) {
	ret := _m.Called(id, title, interval)
	...
	var r0 *domain.Routine
	var r1 error
	if rf, ok := ret.Get(0).(func(int, string, string) (*domain.Routine, error)); ok {
		return rf(id, title, interval)
	}
	if rf, ok := ret.Get(0).(func(int, string, string) *domain.Routine); ok {
		r0 = rf(id, title, interval)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.Routine)
		}
